...
class Settings(BaseSettings):
    ...
    command_timeout: int = Field(default=300, ge=1, le=3600, alias="COMMAND_TIMEOUT")  # 1 second to 1 hour
    ...
    log_file: str = Field(default="/tmp/azure_cli_mcp.log", alias="LOG_FILE")
    
    # Web settings
    web_host: str = Field(default="127.0.0.1", alias="WEB_HOST")
    web_port: int = Field(default=8000, ge=1024, le=65535, alias="WEB_PORT")  # Valid port range
